    ...
    <div className="space-y-3">
      ...
      {strategy === 'legal_id' && (
        <>
          ...
          <Field label="Max Chunk Chars" hint="Blok Pasal terlalu besar akan dipotong oleh RecursiveCharacterChunker. Panduan untuk teks hukum Indonesia (cl100k): ~2.5 karakter ≈ 1 token — target 512 tok → ~1100 chr, target 1024 tok → ~2500 chr">
            <input
              type="number"
              min={500}
